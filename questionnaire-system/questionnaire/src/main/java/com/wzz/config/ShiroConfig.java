...
import com.wzz.shiro.MySessionManager;
import com.wzz.shiro.ShiroLogoutFilter;
import com.wzz.shiro.ShiroSessionIdGenerator;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager") DefaultWebSecurityManager defaultWebSecurityManager) {
        ...
        filerMap.put("/question/*","anon");
        filerMap.put("/link/*", "anon");
        filerMap.put("/analyse/receiveData", "anon");
        filerMap.put("/analyse/analyseData/*", "anon");
        // 添加页面需要的权限

...
public interface UserService {
     ...
     * @return
     */
    List<User> findUserByUsernameWithRole(String username);
    ...
    /**
     * @decription 学生认证myscse
     * @param url
     * @param method
     * @param params
     * @return
     */
    String sendScse(String url, HttpMethod method, MultiValueMap<String, String> params);
